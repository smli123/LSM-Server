...
public class NotifyCurtainStatusHandle implements ICallFunction{
	...
	/**********************************************************************************************************
	 * @name NotifyCurtainStatusHandle 处理模块主动上报继电器状的处理流程
	 * @param 	strMsg: 响应字符串 
	 * 					格式：  cookie, NOTIFYCURTAIN,<username>,< moduleid >，<returncode>, <status01>, <status02>, <status03>, ..., <status20>
	 * 								< moduleid >：模块ID
...
//			}
			...
			NotifyToAPP(info.getUserName(),strDevId, ServerCommDefine.NOTIFY_CURTAIN_STATUS, 
					ServerRetCodeMgr.SUCCESS_CODE,  strStatus);
			
			//通知模块通知已收到
			ResponseToModule(strDevId, String.format("%s#", ServerCommDefine.NOTIFY_CURTAIN_STATUS));
