 ...
 * */
public class MODULE_BATTERYCHARGE {
	public final static String 	TABLE_NAME 				= "module_batterycharge";
	...
	public MODULE_BATTERYCHARGE(String strModuleId, Timestamp dtOperDate, double dCharge)
	{
	...
	public boolean Equal(MODULE_BATTERYCHARGE info)
	{
		if(info == null)
		{
			return false;
